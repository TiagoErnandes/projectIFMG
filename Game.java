...
public class Game
{
    ...
    {
        Room outside, theatre, pub, lab, office,dca,sabara,ifmg;
        ...
        dca =  new Room("in the dca");
        sabara = new Room("in the sabara");
        ifmg = new Room("in the IFMG");

        // initialise room exits
        outside.setExit("east",theatre);
        outside.setExit("weast",theatre);
        outside.setExit("south",office);
        outside.setExit("up",theatre);
        outside.setExit("northeast",theatre);


        theatre.setExit("south", outside);
        theatre.setExit("weast", lab);
        theatre.setExit("up", office);

        dca.setExit("east", pub);
        dca.setExit("north", office);

        pub.setExit("west",outside);
        lab.setExit("up", office);
        office.setExit("northeast", sabara);
    ...
    private boolean processCommand(Command command)
    {
        ...
        else if (commandWord.equals("scout"))
            lookAround(command);
        return wantToQuit;
    }
    ...
    private void printHelp()
    {
        ...
        System.out.println(parser.todosComandos());
        System.out.println();
    }
